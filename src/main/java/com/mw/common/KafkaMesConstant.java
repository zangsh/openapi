...
public class KafkaMesConstant {
    ...
    /*kakfa-mes*/
    public static final String KAFKA_SEND_ERROR_MES = "发送消息超时,请联系管理员";
    public static final String KAFKA_NO_RESULT_MES = "未查询到返回结果,请联系管理员";
    public static final String KAFKA_NO_OFFSET_MES = "未查到返回数据的offset,请联系管理员";
}
